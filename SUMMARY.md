...
* [Template Management](getting-started/template-management/README.md)
  * [Creating a Template](getting-started/template-management/creating-a-template/README.md)
    * [Configuring Input](getting-started/template-management/creating-a-template/configuring-input.md)
    * [Defining Data Sources and Process Levels](getting-started/template-management/creating-a-template/defining-data-sources-and-process-levels.md)
    * [Configuring Output](getting-started/template-management/creating-a-template/configuring-output.md)
    * [Working with Simple Objects](getting-started/template-management/creating-a-template/working-with-simple-objects.md)
    * [Working with Complex Objects](getting-started/template-management/creating-a-template/working-with-complex-objects.md)
    * [Adding Computations](getting-started/template-management/creating-a-template/adding-computations.md)
  * [Conditions & Actions](getting-started/template-management/conditions-and-actions/README.md)
