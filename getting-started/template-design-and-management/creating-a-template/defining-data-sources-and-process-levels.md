...
To manage batch configurations, click <mark style="color:green;">**\<icon>**</mark>. [Click here](../../template-processing/large-volume-document-generation-batch-processing/setting-up-the-environment.md) to know more about batch configurations.
