...
To activate/deactivate an organization, select **Edit** (![](<../.gitbook/assets/image (1).png>)), change the status and select **Save**.&#x20;
...
To change a role's status to active/inactive, select **Edit** (![](<../.gitbook/assets/image (1).png>)), change the status and select **Save**.&#x20;
