...
* To insert an image:
  * Select **Image** or press <kbd><mark style="color:$primary;">Ctrl+Alt+I<mark style="color:$primary;"></kbd>
  * Select the image file (PNG / JPG / JPEG) and select **Open**
* To insert a hyperlink:
  * Select **Hyperlink** or press <kbd><mark style="color:$primary;">Ctrl+Alt+H<mark style="color:$primary;"></kbd>&#x20;
...
To view a mail profile settings, click **Edit** (![](<../../../../../.gitbook/assets/image (8) (1) (1).png>))

To view the email message, click **Mail Body** (![](<../../../../../.gitbook/assets/image (9) (1) (1).png>))

To delete an unwanted mail profile, click **Delete** (![](<../../../../../.gitbook/assets/image (10) (1) (1).png>))
