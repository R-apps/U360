...
These include text, images, barcodes, shapes, tables, signatures, and dynamic fields mapped to input data. To understand the objects available in UniServe 360, [click here](/broken/pages/fTxZeyNdL3b3hrAJQcmn).&#x20;
